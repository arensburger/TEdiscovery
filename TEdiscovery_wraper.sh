...
perl $TEdiscoveryPath/rm2gff3-dev.pl -r $rmoutput -c $consensi2outputfile -o $rm2gffout
...
# produce reports
perl $TEdiscoveryPath/report-tir-ele-overlap-dev.pl -r $rm2gffout -t $gname-tir-TA.bed -g $genome -d $TEdiscoveryPath/repbase_classII.fa -o $gname-tirele-TA-report.xls
perl $TEdiscoveryPath/report-tir-ele-overlap-dev.pl -r $rm2gffout -t $gname-tir-4TSD.bed -g $genome -d $TEdiscoveryPath/repbase_classII.fa -o $gname-tirele-4TSD-report.xls 
perl $TEdiscoveryPath/report-tir-ele-overlap-dev.pl -r $rm2gffout -t $gname-tir-8TSD.bed -g $genome -d $TEdiscoveryPath/repbase_classII.fa -o $gname-tirele-8TSD-report.xls
